...
CREATE VIEW [dbo].[vDimDerivedActivity_Date]
AS

SELECT DATE_ID AS DerivedActivity_DATE_ID
	,SHORT_DATE AS DerivedActivity_DATE
	--,CAST(DAY_CAPTION AS DATE) AS EST_REV_DATE
	,MONTH_ID AS DerivedActivity_MONTH_ID
	,WEEK_ID AS DerivedActivity_WEEK_ID
	,DAY_OF_WEEK AS DerivedActivity_DAY_OF_WEEK
	,DAY_OF_WEEK_NUMBER AS DerivedActivity_DAY_OF_WEEK_NUMBER
	,LAST_YEAR_SAME_DAY_ID AS DerivedActivity_LAST_YEAR_SAME_DAY_ID
	...
	,LAST_YEAR_QTR_END_DATE_ID AS DerivedActivity_LAST_YEAR_QTR_END_DATE_ID
